...
"#!/bin/bash
tag=$(curl -sI https://github.com/necaran/mpv/releases/latest | grep 'location: https://github.com/necaran/mpv/releases' | sed 's#.*/##g' | tr -d '\r')
printf 'https://github.com/necaran/mpv/archive/%s.tar.gz' $tag")
